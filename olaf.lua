...
function kao:__init()
	...
	ToUpdate.CallbackNewVersion = function(NewVersion) print("<font color=\"##7D26CD\"><b>Olaf - the Berserker </b></font> <font color=\"#FFFFFF\">New Version found ("..NewVersion.."). Please wait until its downloaded</b></font>") end
	ToUpdate.CallbackError = function(NewVersion) print("<font color=\"##7D26CD\"><b>Olaf - the Berserker </b></font> <font color=\"#FFFFFF\">Error while Downloading. Please try again.</b></font>") end
